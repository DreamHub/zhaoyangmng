...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="wrap">
			...
			<div class="main">
				<div><img src="${path}image/recruitment/01.gif"/>
				</div>
				<p class="bread_crumb">
				...
				<div class="clearfix">
					<div class="left">
						<div id="recruitment">
							<h2><img src="${path}image/recruitment/04.gif"/></h2>
							<ul>
								<li>
									“Nibiru”他是众神中最伟大的天体，它的回归预示着新的时代的开始。而在触摸游戏大肆横行的当下
								</li>
								<li>
									“Nibiru”他是众神中最伟大的天体，它的回归预示着新的时代的开始。而在触摸游戏大肆横行的当下
								</li>
								...
								<li>
									“Nibiru”他是众神中最伟大的天体，它的回归预示着新的时代的开始。而在触摸游戏大肆横行的当下神中最伟大的天体，它的回归预示着新的时代的开始。而在触摸游戏大肆横行的
								</li>
								<li>
									“Nibiru”他是众神中最伟大的天体，它的回归预示着新的时代的开始。而在触摸游戏大肆横行的当下神中最伟大的天体，它的回归预示着新的时代的开始。而在触摸游戏大肆横行的
								</li>
							...
							<div class="recruitmentdesc">
								<h3><img src="${path}image/recruitment/15.gif"/></h3>
					...
					<div class="right">
						...
						<div class="recruitmentwarn">
							...
							<ul>
								...
								<li>简历投至:<span>111kkkkssiii@qq.com</span></li>
								<li>传统手柄游戏时代强势回归。移动时代，也将是传统手柄</li>
								<li>传统手柄游戏时代强势回归。移动时代，也将是传统手柄</li>
								<li>传统手柄游戏时代强势回归。移动时代，也将是传统手柄</li>
							</ul>
