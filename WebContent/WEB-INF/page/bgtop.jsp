...
<div class="header">
	...
	<div class="right_header">
		欢迎您, ${sessionScope.userInfo}, <a href="http://zhaoyang.ucoz.com/index.html" target="_blank">朝之阳官网</a> | <a href="#" onclick="javascript:alert('抱歉,目前版本不支持此项操作');return false;">换肤</a> | <a href="#"
