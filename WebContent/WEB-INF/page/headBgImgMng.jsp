		...
		<div class="main_content">
			...
			<div class="center_content">
				...
				<div class="right_content">
					...
					<h3>网页头部背景图片：</h3>
					<div class="form">
						<form action="${path}other/HeadImgEditAction" method="post" class="niceform" enctype="multipart/form-data">
						<fieldset>
								<dl>
									<dt>
										<label for="email">当前图片<s:property value="key"/>:
										</label>
									</dt>
									<dd>
										<img width="100%" src="${path}${headImgPath}" style="border: 1px solid #ccc;"/>
									</dd>
								</dl>
								<dl>
									<dt>
										<label for="email">新图片<s:property value="key"/>:
										</label>
									</dt>
									<dd>
