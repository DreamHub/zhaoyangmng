		...
		<div class="main_content">
			...
			<div class="center_content">
				...
				<div class="right_content">
					...
					<div class="form">
						<form action="${path}news/NewsEditAction" method="post" class="niceform">
							<fieldset>
								<dl>
									<dt>
								...
								<dl>
									...
									<dd>
										<input type="text" name="title" id="" size="54" value="<s:property value="title"/>"/>
									</dd>
								</dl>
								<dl>
									<dt>
									...
									<dd>
										<input type="text" name="newsDesc" id="" size="54" value="${newsDesc}"/>
									</dd>
								</dl>
								<dl>
									<dt>
									...
									<dd>
										<input type="text" name="newsKeyword" id="" size="54" value="${newsKeyword}"/>
									</dd>
								</dl>
								<dl>
									<dt>
								...
								<dl>
									...
									<dd style="width: 150px;">
										...
										<input name="content" type="hidden" id="content" value="<s:property value="content" escape="true"/>" style="display: none"/>
									</dd>
