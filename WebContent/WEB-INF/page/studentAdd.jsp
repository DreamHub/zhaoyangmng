		...
		<div class="main_content">
			...
			<div class="center_content">
				...
				<div class="right_content">
					...
					<div class="form">
						<form action="${path}peo/StudentAddAction" method="post" class="niceform" enctype="multipart/form-data">
							<fieldset>
								...
								<dl>
									...
									<dd>
										<input type="text" name="student.stuName" id="" size="15"/>
									</dd>
								</dl>
								<dl>
									<dt>
									...
									<dd>
										<input type="text" name="student.fromSchool" id="" size="48"/>
									</dd>
								</dl>
								<dl>
									<dt>
									...
									<dd>
										<input type="text" name="student.toSchool" id="" size="48"/>
									</dd>
								</dl>
								<dl>
									<dt>
									...
									<dd>
										<input type="text" name="student.score" id="" size="15"/>
									</dd>
								</dl>
								<dl>
									<dt>
									...
									<dd>
										<input type="text" name="student.desc" id="" size="48"/>
									</dd>
								</dl>
								<dl>
									<dt>
