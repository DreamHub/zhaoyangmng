		...
		<div class="main_content">
			...
			<div class="center_content">
				...
				<div class="right_content">
					...
					<div class="form">
						<form action="${path}ntc/NoticePanelSetAction" method="post" class="niceform" enctype="multipart/form-data">
							<fieldset>
								<dl>
									<dt>
										<label for="comments">公告栏列表:</label>
									</dt>
									<dd>
					...
					<div style="text-align: center;padding: 10px;border: 1px solid #CCEAC4;background: #EDFCE9;">
						<img src="${bgpath}images/20131007171251.jpg"/>	
					</div>
