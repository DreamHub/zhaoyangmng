		...
		<div class="main_content">
			...
			<div class="center_content">
				...
				<div class="right_content">
						...
						<tbody>
							<s:iterator value="tailLinks">
								<tr>
									...
									<td><a href="#" onclick="javascript:alert('抱歉,目前版本不支持此项操作');return false;">
											<img src="${bgpath}images/user_edit.png" alt="" title="" border="0" /> 
										</a>
									</td>
									<td><a
										href="${path}other/TailLinkDelAction?tailLink.id=<s:property value="id"/>"
					...
					<a href="#" class="bt_green"><span class="bt_green_lft"></span><strong>添加链接</strong><span
					...
					<div style="width: 0;height: 0;overflow: hidden;">
						<div id="newnoticedl" class="form">
							<form action="${path}other/TailLinkAddAction" method="post" class="niceform" id="imgloopform">
							<fieldset>
								<dl>
							<dt>
							...
							<dd>
								<input type="text" name="tailLink.text" id="newcontent" size="54"
									value="" />
							</dd>
						</dl>
						<dl>
							...
							<dd>
								<input type="text" name="tailLink.href" id="newhref" size="54"
									value="" />
							</dd>
						</dl>
								<dl class="submit">
