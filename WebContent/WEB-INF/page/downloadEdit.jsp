		...
		<div class="main_content">
			...
			<div class="center_content">
				...
				<div class="right_content">
					...
					<div class="form">
						<form action="${path}dld/DownloadEditAction" method="post" class="niceform" enctype="multipart/form-data">
							<fieldset>
								<dl>
									<dt>
										<label for="password">当前资源路径:</label>
									</dt>
									<dd>
										<s:property value="hrefPath"/>
										<input type="hidden" name="id" value="<s:property value="id"/>"/>
									</dd>
								</dl>
								<dl>
									<dt>
										<label for="email">上传新资源:</label>
									</dt>
									<dd>
								...
								<dl>
									...
									<dd>
										<input type="text" name="srcName" id="" size="54" value="<s:property value="srcName"/>"/>
									</dd>
								</dl>
								<dl class="submit">
