		...
		<div class="main_content">
			...
			<div class="center_content">
				...
				<div class="right_content">
					...
					<div class="form">
						<form action="${path}peo/TeacherAddAction" method="post" class="niceform" enctype="multipart/form-data">
							<fieldset>
								...
								<dl>
									...
									<dd>
										<input type="text" name="teacher.teaName" id="" size="15"/>
									</dd>
								</dl>
								<dl>
									<dt>
									...
									<dd>
										<input type="text" name="teacher.project" id="" size="15"/>
									</dd>
								</dl>
								<dl>
									<dt>
									...
									<dd>
										<input type="text" name="teacher.service" id="" size="48"/>
									</dd>
								</dl>
								<dl>
									<dt>
									...
									<dd>
										<textarea name="teacher.feature" id="comments" rows="3" cols="30"></textarea>
									</dd>
								</dl>
								<dl>
									<dt>
