		...
		<div class="main_content">
			...
			<div class="center_content">
				...
				<div class="right_content">
					...
					<div class="form">
						<form action="${path}peo/TeacherEditAction" method="post" class="niceform" enctype="multipart/form-data">
							<fieldset>
								
								<dl>
									<dt>
										<label for="comments">教师姓名:</label>
									</dt>
									<dd>
										<input type="text" name="teacher.teaName" id="" size="15" value="<s:property value="teacher.teaName"/>"/>
										<input type="hidden" name="teacher.id" value="<s:property value="teacher.id"/>"/>
										<input type="hidden" name="teacher.photoImg" value="<s:property value="teacher.photoImg"/>"/>
									</dd>
								</dl>
								<dl>
									<dt>
										<label for="comments">科目:</label>
									</dt>
									<dd>
										<input type="text" name="teacher.project" id="" size="15" value="<s:property value="teacher.project"/>"/>
									</dd>
								</dl>
								<dl>
									<dt>
										<label for="comments">适合对象:</label>
									</dt>
									<dd>
										<input type="text" name="teacher.service" id="" size="48" value="<s:property value="teacher.service"/>"/>
									</dd>
								</dl>
								<dl>
									<dt>
										<label for="comments">教学特色:</label>
									</dt>
									<dd>
										<textarea name="teacher.feature" id="comments" rows="3" cols="30"><s:property value="teacher.feature"/></textarea>
									</dd>
								</dl>
								<dl>
									<dt>
										<label for="upload">当前图片:</label>
									</dt>
									<dd style="overflow: hidden;">
										<img src="${path}<s:property value="teacher.photoImg"/>"/>
									</dd>
								</dl>
								<dl>
									<dt>
