		...
		<div class="main_content">
			...
			<div class="center_content">
				...
				<div class="right_content">
					...
					<div class="form">
						<form action="${path}ntc/NoticeAddAction" method="post" class="niceform">
							<fieldset>
								<dl>
									<dt>
								...
								<dl>
									...
									<dd style="width: 150px;">
										...
										<input name="content" type="hidden" id="content" value="<s:property value="content"/>"/>
									</dd>
								</dl>
								<dl class="submit">
