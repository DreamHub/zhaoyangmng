...
ddaccordion.init({
	...
	togglehtml: ["suffix", "<img src='${bgpath}images/plus.gif' class='statusicon' />", "<img src='${bgpath}images/minus.gif' class='statusicon' />"], //Additional HTML added to the header when it's collapsed and expanded, respectively  ["position", "html1", "html2"] (see docs)
...
<div id="main_container">
	...
	<div class="header">
    <div class="logo"><a href="#"><img src="${bgpath}images/logo.gif" alt="" title="" border="0" /></a></div>
    
    <div class="right_header">欢迎您, ${sessionScope.userInfo}, <a href="#">朝之阳官网</a> | <a href="#" class="messages">(3) 消息</a> | <a href="#" class="logout">退出</a></div>
    ...
    <div class="main_content">
                    ...
                    <li><a href="${path}news/NewsMngAction?pageNum=1">新闻动态管理<!--[if IE 7]><!--></a><!--<![endif]-->
    ...
    <div class="left_content">
            ...
            <input type="image" class="search_submit" src="${bgpath}images/search.png" />
            </form>            
            </div>
            ...
            <div class="sidebar_box">
                ...
                <img src="${bgpath}images/info.png" alt="" title="" class="sidebar_icon_right" />
                <p>
Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            ...
            <div class="sidebar_box">
                ...
                <img src="${bgpath}images/notice.png" alt="" title="" class="sidebar_icon_right" />
                <p>
Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                </p>                
                </div>
            ...
            <div class="sidebar_box">
                ...
                <img src="${bgpath}images/photo.png" alt="" title="" class="sidebar_icon_right" />
                <p>
Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                </p>                
                </div>
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    ...
    <tbody>
    	<tr>
            ...
            <td><a href="#"><img src="${bgpath}images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="#" class="ask"><img src="${bgpath}images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
	 ...
	 <a href="#" class="bt_green"><span class="bt_green_lft"></span><strong>添加新记录</strong><span class="bt_green_r"></span></a>
     <a href="#" class="bt_blue"><span class="bt_blue_lft"></span><strong>View all items from category</strong><span class="bt_blue_r"></span></a>
     <a href="#" class="bt_red"><span class="bt_red_lft"></span><strong>删除记录</strong><span class="bt_red_r"></span></a> 
    ...
    <div class="footer">
    	<div class="left_footer">朝之阳后台管理 | Powered by <a href="http://indeziner.com">诚彬工作室</a></div>
    	<div class="right_footer"><a href="http://indeziner.com"><img src="${bgpath}images/indeziner_logo.gif" alt="" title="" border="0" /></a></div>
    </div>
